...
class HttpProvider
{
    ...
    {
        return ($_SERVER['REQUEST_METHOD'] == 'GET') ? self::REQUEST_METHOD_GET : self::REQUEST_METHOD_POST ;
    }
    ...
    {
        echo "<pre>[GET] ".print_r($_FILES, true)."</pre>";
    }
    /**
     ...
     * @param int $statusCode
     */
    public static function flush_json($data=[], $statusCode=200)
    {
        http_response_code($statusCode);
     ...
     * @return mixed
     */
    public static function get_request_time($float = false)
    {
